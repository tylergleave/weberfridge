export const translations = {
  en: {
    ...
    events: {
      ...
      weberEatsDesc: 'Free pizza (provided by Sizzling Platter Little Caesars), free crafts, live music, and a Really Really Free Market — presented by Weber Fridge & USARA.\n\nBring a side to share if you can! Volunteers arrive at 1 PM.',
  ...
  es: {
    ...
    events: {
      ...
      weberEatsDesc: 'Pizza gratis (cortesía de Sizzling Platter Little Caesars), manualidades gratis, música en vivo y un Mercado Completamente Gratuito — presentado por Weber Fridge y USARA.\n\n¡Trae algo para compartir si puedes! Los voluntarios llegan a la 1 PM.',
